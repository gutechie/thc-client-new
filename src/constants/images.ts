export const images = Object.freeze({
  social: {
    GOOGLE: require("../assets/images/social-icons/google.png"),
    STRAVA: require("../assets/images/social-icons/strava.png"),
    FITBIT: require("../assets/images/social-icons/fitbit.png"),
  },
  LOGIN_BG: require("../assets/images/login-bg.png"),
