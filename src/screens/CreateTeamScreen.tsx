import {
    Box,
    Button,
    Heading, HStack, Icon, Input, Pressable, ScrollView, VStack, Text, Image, Toast
} from "native-base";
...
export const CreateTeamScreen = ({navigation}) => {
    ...
    const handleCreate = async () => {
        try {
            ...
            console.log(e);
            Toast.show({title: "Error creating team", description: e.data ? e.data.message : 'Something gone wrong.'})
        }
    };
            ...
            <ScrollView p={8}>
                <VStack space={4}>
                    ...
                    <Pressable onPress={pickImage}>
                        ...
                        {logo && <HStack justifyContent={"center"}>
